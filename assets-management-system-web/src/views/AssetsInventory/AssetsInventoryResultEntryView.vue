<template>
<!-- 盘点结果录入 -->
<div class="assets-inventory-result-entry-view">
    <div class="top">
        <div class="left">
...
import { assetsClassSelect } from '../../data/DataListOperating'
    ...
    methods: {
        ...
        operator(line) {
            ...
            if (line.result === '正常' || line.result === '异常') {
                ...
                return { 'input-result': inputResult }
            }
        },
        enterBatch() {
            let idList = []
            ...
            Service.getById(
                ...
                (data) => {
                    ...
                    Service.joinList(
                        ...
                        [
                            { operator: 'eq', values: ['assetsInventoryId', this.assetsInventory.id] },
                            ...conditions
                        ],
                        (data) => {
                            this.dataList = data
